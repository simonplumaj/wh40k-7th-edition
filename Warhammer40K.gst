...
<gameSystem id="e1ebd931-a209-3ce4-87b4-d9918d25530b" name="40K Custom" revision="1" battleScribeVersion="2.03" authorName="Simon Plumaj" authorContact="simon.plumaj@gmail.com" authorUrl="" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <publications>
  ...
  <forceEntries>
    ...
    <forceEntry id="f27ddc58-26a0-c164-64d5-75065a3d9620" name="Unbound Army" hidden="false">
      <constraints>
        <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="minSelections" type="min"/>
      </constraints>
      <categoryLinks>
